  ...
  return (
    <React.Fragment>
      <section id="information">
        <h2>Information</h2>
        <p>
          Win Bank Machine Token - 0x892e571B4B993CC4327e34a15527b26C254871D2
          <br />
          <br />
          The value of Win will rise as more users invest BUSD.
          <br />
          <br />
          <b>Process</b>
          <br />
          <br />
          1.1. Enter BUSD into the Win Token bank machine and earn daily staking
          rewards in WIn Bank tokens (4% per day). You can claim your Win
          Bank rewards at anytime. You cannot unstake your BUSD.
          <br />
          1.2. You will earn Win as a percentage of BUSD invested irrespective
          of the WIN Token Price.
          <br />
          1.3. i.e. If you invest 100 BUSD you will receive 4 Win per day. per
          day
          <br />
          <br />
          2. You have two options with your Win, you can sell them for BUSD, or
          you can stake them to earn more Win (6% per day). Win staking is
          locked for 7 days.
          <br />
          <br />
          3. Terminology
          <br />
          3.1. Total Supply : The maximum amount of Win that can exist
          <br />
          ...
          you claim Win from minting, it is removed from the Available Supply
        ...
        <section className="effect-gold-borders">
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td id="total-referrals">
                {splitAndAdd(totalReferral)}
                </td>
              </tr>
            </tbody>
          </table>
          <button id="withdraw-referral-btn" className="btn-gold" onClick={withDrawBonus}>
          ...
          <p>
            ...
            <br /> You will receive:
            <br />
            <br /> 4% from each level 1 referral deposits 2% from each level 2
            referral deposits 1% from each level 3 referral deposits <br />
            <br />
